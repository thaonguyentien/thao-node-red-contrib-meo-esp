module.exports = function(RED) {
  ...
  function MEOESPInNode(config) {
    ...
    console.console.log(${config.deviceId});
    this.qos = 2;
    ...
    if (this.brokerConn) {
      ...
      this.error(RED._("thao-mqtt.errors.missing-config"));
    }
  ...
  RED.nodes.registerType("thao-meo-esp-in", MEOESPInNode);
  ...
  RED.nodes.registerType("thao-meo-esp-out", MEOESPOutNode);
}
